...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: globalMethod.futureBuildersFunction(
                      ...
                      children: [
                        ...
                        Obx(
                          () => _editProfileViewModel.dateValue.isEmpty
                              ? Container()
                              : Text(
                                  "${_editProfileViewModel.dateValue[0]!.day}  ${globalMethod.monthName(_editProfileViewModel.dateValue![0]!.month)},   ${_editProfileViewModel.dateValue![0]!.year}",
                                  style: GoogleFonts.poppins(
                                      fontSize: 14,
        ...
        FutureBuilder<DocumentSnapshot>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasError) {
                return globalMethod.errorDialog(
