...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'enter_your_digit_number': 'Please enter your 11-digit phone number',
          ...
          'default-message':
              'Please check your internet connection or other issues.',
        ...
        'bn_BD': {
          ...
          //Registration
          "enter_your_full_name": "আপনার সম্পূর্ণ নাম লিখুন",
          "name": "নাম",
          "phone": "মোবাইল নাম্বার",
          'enter_phone_number': 'ফোন নম্বর লিখুন',
          'enter_your_phone_number': 'অনুগ্রহ করে আপনার ফোন নম্বর লিখুন',
          'enter_your_digit_number':
              'অনুগ্রহ করে আপনার ১১-সংখ্যার ফোন নম্বর লিখুন',
          "confirm_password": "কনফার্ম পাসওয়ার্ড",
          "enter_confirm_password": "কনফার্ম পাসওয়ার্ড লিখুন",
          'please_enter_confirm_password': 'অনুগ্রহ করে আপনার কনফার্ম পাসওয়ার্ড লিখুন',
          "gender":"লিঙ্গ",
          "male":"পুরুষ",
          "female":"মহিলা",
          "other":"অন্যান্য",
          ...
          "please_verify_your_email":
              "আপনার ইমেইল ঠিকানা এখনো যাচাই হয়নি। আপনার ইমেইল যাচাই করুন যাতে চালিয়ে যান।",
          ...
          'invalid-email':
              'অবৈধ ইমেইল ঠিকানা। দয়া করে একটি বৈধ ইমেইল ঠিকানা লিখুন।',
          'invalid-email-title': 'অবৈধ ইমেইল ঠিকানা',
          'invalid-credential':
              'অবৈধ ইমেইল বা পাসওয়ার্ড। দয়া করে আপনার শংসাপত্র পরীক্ষা করুন এবং আবার চেষ্টা করুন।',
          'invalid-credential-title': 'ইমেইল বা পাসওয়ার্ড পরীক্ষা করুন',
          'weak-password':
              'শক্তিহীন পাসওয়ার্ড। দয়া করে একটি শক্তিশালী পাসওয়ার্ড লিখুন।',
          ...
          'default-message':
              'দয়া করে আপনার ইন্টারনেট সংযোগ পরীক্ষা করুন বা অন্যান্য সমস্যা পরীক্ষা করুন।',
